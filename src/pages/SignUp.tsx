...
export default function SignUp() {
  ...
  useEffect(() => {
    ...
    if (!azureConfig) {
      toast.warning("Please configure Azure AI settings before signing up", {
        duration: 5000,
      });
    }
  }, []);
  ...
  const handleGoogleSignUp = async () => {
    ...
    const azureConfig = getAzureAIConfig();
    if (!azureConfig) {
      toast.error("Please configure Azure AI settings before signing up");
      return;
    }
  ...
  const handleEmailSignUp = async (e: React.FormEvent) => {
    ...
    // In a real implementation, you would register against your Azure backend
    toast.error("Email/password registration not implemented. Please use Google Sign-Up.");
  };
